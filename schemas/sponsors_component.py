...
from .sponsors import Sponsor, Level
...
class SponsorsComponent(BaseComponentSchema):
    ...
    sponsors: list[Sponsor] = Field([], title="Sponsors List", description="List of sponsors with their details.")
    levels: list[Level] = Field([], title="Levels List", description="List of sponsor levels.")
