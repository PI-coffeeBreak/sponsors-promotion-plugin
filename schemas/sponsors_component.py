...
class SponsorsComponent(BaseComponentSchema):
    ...
    sponsors: list = Field(default_factory=list, title="Sponsors List", description="List of sponsors with their details.")
    levels: list = Field(default_factory=list, title="Levels List", description="List of sponsor levels.")
